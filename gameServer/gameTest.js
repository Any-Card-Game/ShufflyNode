...
var api = require('./GameAPI.js');


exports.Sevens = function () {
    var self = this;
    ...
    self.constructor = function () {
        ...
        self.cardGame.users.push(new User("sal"));
        self.cardGame.users.push(new User("joe"));
        self.cardGame.users.push(new User("mike"));
    };
    self.runGame = function () {
        ...
        while (true) {
            self.cardGame.users.foreach(function (u) { 
                ...
                var de = askQuestion(u, 'Which card would you like to play?', answers, self.cardGame);
